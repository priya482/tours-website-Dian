...
def contact(request):
    if request.method == 'POST':
        ...
        return redirect(request, 'destinations.html')
...
def receipt(request):
    ...
    # print(adults)
    if rooms > 1:
        totalCost = round(tour_amount*adults + tour_amount*children/2 + rooms*tour_amount/4)
    else:
        totalCost = round(tour_amount*adults + tour_amount*children/2)
